...
using eCommerce.WebUI.Tests.Mocks;
...
namespace eCommerce.WebUI.Tests.Controllers
{
    ...
    public class BasketControllerTests
    {
        ...
        public void CanCheckoutAndCreateOrder()
        {
            ...
            customers.Insert(new Customer() { Id = "1", Email = "generic@gmail.com", Zipcode = "77777" });
            IPrincipal FakeUser = new GenericPrincipal(new GenericIdentity("generic@gmail.com", "Forms"),null);
